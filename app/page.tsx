...
export default function Home(){
  ...
  return <main>
    ...
    <section className="hero" id="top"><div><p className="eyebrow">BẢNG XẾP HẠNG ÂM NHẠC CHÂU Á</p><h1>Biết bài nào đang<br/>được <em>nghe nhiều.</em></h1><p className="hero-copy">Theo dõi Top 10 Apple Music tại Hàn Quốc, Nhật Bản và Trung Quốc — cập nhật tự động, không cần đăng nhập.</p></div><div className="hero-stat"><strong>03</strong><span>THỊ TRƯỜNG<br/>DỮ LIỆU TRỰC TIẾP</span></div></section>

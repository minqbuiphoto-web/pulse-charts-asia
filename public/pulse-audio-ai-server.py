...
def safe_font(value: str, fallback: str) -> str:
    ...
    verified = {
        ...
        "calibri": "Calibri", "cambria": "Cambria", "constantia": "Constantia",
        "palatino linotype": "Palatino Linotype", "sitka display": "Sitka Display",
        "sitka text": "Sitka Text", "candara": "Candara", "corbel": "Corbel",
